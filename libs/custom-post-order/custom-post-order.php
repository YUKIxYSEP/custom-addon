...
class SCPO_Engine {
	...
	// 	include SCPORDER_DIR . 'class-review.php';
	// }
	...
	public function load_scpo_textdomain() {
		...
		load_plugin_textdomain( 'custom-post-order', false, basename( dirname( __FILE__ ) ) . '/languages/' );
	}
	...
	public function admin_menu() {
		add_options_page( __( 'SCPOrder', 'custom-post-order' ), __( '並び替え設定', 'custom-post-order' ), 'manage_options', 'scporder-settings', array( $this, 'admin_page' ) );
	}
